...
To wait for the connection, do login, etc. we'll use a view that will take care of the different connection states our app will have. This View is called [`SyncContentView`](/docs/ios-app-changes/synccontentview), son we'll show that on App Startup.
